            ...
            <div className="row g-5 mx-lg-0">
                <div className="col-lg-6 feature-text wow fadeInUp" data-wow-delay="0.1s">
                    <h6 className="text-primary text-uppercase mb-3"
                        style="font-size:40px; position:relative; bottom:80px; left:450px;">Why You Choose Us</h6>
                    ...
                    <div className="d-flex mb-5 wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div className="ms-4">
                            ...
                            <p className="mb-0">Diam dolor ipsum sit amet eos erat ipsum lorem sed stet lorem sit clita duo
                ...
                <div className="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
